    ...
    <main className=" space-y-8">
      <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
        <Card className="sm:col-span-2" x-chunk="dashboard-05-chunk-0">
          ...
          <CardFooter>
            <Link href={"/dashboard/chequier"}>
              <Button>Commander un chéquier</Button>
            </Link>
          </CardFooter>
        </Card>
        <Card x-chunk="dashboard-01-chunk-0">
          ...
          <CardFooter>
            <Progress value={20.1} aria-label="25% increase" />
          </CardFooter>
        </Card>
        <Card x-chunk="dashboard-01-chunk-1">
          ...
          <CardFooter>
            <Progress value={180.1} aria-label="25% increase" />
          </CardFooter>
        </Card>
        <Card x-chunk="dashboard-01-chunk-2">
          ...
          <CardFooter>
            <Progress value={19} aria-label="25% increase" />
          </CardFooter>
        </Card>
